...
4.  Prompts you to run the interactive setup wizard (`sinc --setup`).
...
If you want an AI assistant to walk you through setup, paste this into your LLM agent session:
