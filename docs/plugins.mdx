...
![AI Sessions MCP demo](https://private-user-images.githubusercontent.com/844866/497479657-c75edc64-32f0-4deb-93d6-301c1e01ea81.gif)
...
# (run `curl -fsSL https://sincronizado.micr.dev/install.sh | bash` and pick Custom/Full)
